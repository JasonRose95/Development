...
struct StoryBrain{
    ...
    func updateUI(storyLabel:UILabel!, choice1Button:UIButton!, choice2Button:UIButton!){
    ...
    mutating func nextStory(userChoice: String){
        ...
        if position + 2 >= stories.count{
            position = 0
        } else if userChoice == stories[position].choice1 {
            position = stories[position].choice1Destination
        } else if userChoice == stories[position].choice2 {
